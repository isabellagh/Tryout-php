  ...
  <body class="bg-gray-100">
    ...
    >
      ...
      <div class="container mx-auto text-center z-10">
        <h2 class="text-4xl text-white font-bold mb-4">Find Your Dream Team</h2>
    ...
    <section class="bg-blue-900 text-white py-6 text-center">
      <div class="container mx-auto">
        ...
        <p class="text-lg mt-2">
          Discover the perfect opportunity for you.
        </p>
      </div>
    </section>
    ...
    <section>
      <div class="container mx-auto p-4 mt-4">
        <div class="text-center text-3xl mb-4 font-bold border border-gray-300 p-3">Recent Chances</div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <!-- Job Listing 1: Software Engineer -->
          <div class="rounded-lg shadow-md bg-white">
            <div class="p-4">
              <h2 class="text-xl font-semibold">Soccer Deffense</h2>
              <p class="text-gray-700 text-lg mt-2">
                We are seeking a skilled deffense.
              </p>
              <ul class="my-4 bg-gray-100 p-4 rounded">
                ...
                <li class="mb-2">
                  <strong>Tags:</strong> <span>Soccer</span>,
                  <span>Deffense</span>
                </li>
              </ul>
              <a href="details.html"
          ...
          <div class="rounded-lg shadow-md bg-white">
            <div class="p-4">
              <h2 class="text-xl font-semibold">Volleyball Setter</h2>
              <p class="text-gray-700 text-lg mt-2">
                We are looking for a great volleyball setter.
              </p>
              <ul class="my-4 bg-gray-100 p-4 rounded">
                ...
                <li class="mb-2">
                  <strong>Tags:</strong> <span>Volleyball</span>,
                  <span>Setter</span>
                </li>
              </ul>
              <a href="details.html"
          ...
          <div class="rounded-lg shadow-md bg-white">
            <div class="p-4">
              <h2 class="text-xl font-semibold">Tennis Player</h2>
              <p class="text-gray-700 text-lg mt-2">
                Join our team as Tennis Player.
              </p>
              <ul class="my-4 bg-gray-100 p-4 rounded">
                ...
                <li class="mb-2">
                  <strong>Tags:</strong> <span>Tennis</span>,
                  <span>Single</span>
                </li>
              </ul>
              <a href="details.html"
          ...
          <div class="rounded-lg shadow-md bg-white">
            <div class="p-4">
              <h2 class="text-xl font-semibold">Soccer Goal Keeper</h2>
              <p class="text-gray-700 text-lg mt-2">
                We are hiring a Goal Keeper.
              </p>
              <ul class="my-4 bg-gray-100 p-4 rounded">
          ...
          <div class="rounded-lg shadow-md bg-white">
            <div class="p-4">
              <h2 class="text-xl font-semibold">Swimmer</h2>
              <p class="text-gray-700 text-lg mt-2">
                Join our dream team as a stroke swimmer.
              </p>
              <ul class="my-4 bg-gray-100 p-4 rounded">
                ...
                <li class="mb-2">
                  <strong>Tags:</strong> <span>Soccer Middle Field</span>,
                  <span>Middle Field</span>
                </li>
              </ul>
              <a href="details.html"
                class="block w-full text-center px-5 py-2.5 shadow-sm rounded border text-base font-medium text-indigo-700 bg-indigo-100 hover:bg-indigo-200"
          ...
          <div class="rounded-lg shadow-md bg-white">
            <div class="p-4">
              <h2 class="text-xl font-semibold">Volleyball libero</h2>
              <p class="text-gray-700 text-lg mt-2">
                We're looking for a Volleyball libero.
              </p>
              <ul class="my-4 bg-gray-100 p-4 rounded">
      ...
      >
        <div>
          ...
          <p class="text-gray-200 text-lg mt-2">
            Post your job listing now and find the perfect athlete.
          </p>
        </div>
        <a
          href="post-job.html"
